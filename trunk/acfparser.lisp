        ...
        (cond ((string-equal arg1 "boost")
              ...
              ((string-equal arg1 "overdub")
               (if (not (cmd-keys arg2))
                   ...
                   (mv (overdub (mv-let (wav4 state) (acf-function-h (cons (butlast arg2 1) (butlast (get-last arg2) 1)) (get-last (get-last arg2)) state) wav4)
                                (mv-let (wav5 state) (acf-function-h (cdr commands) wav state) wav5)) state)))
